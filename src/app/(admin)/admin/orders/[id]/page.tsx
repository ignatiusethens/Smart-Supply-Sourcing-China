        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-6 rounded-lg border border-gray-200 space-y-4">
            <div>
              ...
              <Badge
                className={`${paymentStatusColors[order.paymentStatus] || 'bg-gray-100 text-gray-800'} mt-2`}
              >
            ...
            <div>
              ...
              <Badge
                className={`${statusColors[order.orderStatus] || 'bg-gray-100 text-gray-800'} mt-2`}
              >
