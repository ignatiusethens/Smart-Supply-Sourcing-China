...
import { Search, ChevronLeft, ChevronRight, Package, ShoppingCart, FileText, Users, Settings, LogOut } from 'lucide-react';
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <main className="flex-1 p-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Sourcing Requests Management</h1>
                ...
                {isLoading ? (
                  ...
                  <tr>
                    <td colSpan={7} className="px-6 py-12 text-center text-gray-500">
                      ...
                      <p className="text-lg font-medium">No sourcing requests found</p>
